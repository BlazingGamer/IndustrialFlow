...
public class IFUltimateChestplate extends IFChestplate {
	public IFUltimateChestplate() {
		super("industrialflow:chestplateUltimate", IF_Base.tabIF, IF_Base.UltimateArmormat, "industrialflow:textures/armourmodels/ultimate_l1.png");
	}
